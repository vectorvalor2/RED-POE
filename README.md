...
Safe AI Simulation Framework for High-Confidence 3D Asset Management and Rendering); #Endif
...
add an NPC behavior editor with a node-based AI scripting system
